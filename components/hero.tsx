import VideoThumb from "@/public/images/laptop.jpg";
                ...
                <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
                    ...
                    <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
                        ...
                        <p
                            ...
                            data-aos-delay="200"
                        >
                            "Navigate the entrepreneurial landscape with
                            DataPulseXX, the ultimate toolkit designed to fuel
                            your business growth. Our innovative solution offers
                            a suite of features tailored to meet the unique
                            needs of ambitious entrepreneurs, providing the
                            insights, resources, and support you need to
                            transform your vision into reality. Join a community
                            of forward-thinkers and elevate your entrepreneurial
                            venture to new heights with DataPulseXX. Start your
                            success story today!"
                        </p>
                        <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
                            <div data-aos="fade-up" data-aos-delay="400">
                                <a
                                    className="btn text-white bg-green-500 hover:bg-purple-700 w-full mb-4 sm:w-auto sm:mb-0"
                                    href="#0"
                                >
                                    Start free trial
                                </a>
